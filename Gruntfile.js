module.exports = function (grunt) {
  ...
  grunt.registerTask('build', [ 'newer:copy:npm', 'phplint', 'eslint', 'concat', 'uglify', 'import_sass_from_dirs', 'sass', 'postcss', 'cssjanus', 'usebanner', 'clean', 'imagemin', 'svgstore', 'makepot'  ]);
