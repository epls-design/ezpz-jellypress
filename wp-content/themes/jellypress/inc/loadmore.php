...
function jellypress_loadmore_script() {
  ...
  wp_register_script('jellypress_loadmore_scroll', get_template_directory_uri() . '/lib/loadmore-scroll.js', array('jquery'), $js_version);
  wp_register_script('jellypress_loadmore_button', get_template_directory_uri() . '/lib/loadmore-button.js', array('jquery'), $js_version);
}
