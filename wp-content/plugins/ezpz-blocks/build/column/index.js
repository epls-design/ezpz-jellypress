...
/* harmony import */ var _column__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../column */ "./src/column/index.js");
...
function Edit({
  ...
  blockProps.className = blockProps.className + " " + (0,_column__WEBPACK_IMPORTED_MODULE_3__.colWidthToClassName)(width);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   colWidthToClassName: () => (/* binding */ colWidthToClassName)
/* harmony export */ });
 ...
 */
 ...
 // @see https://wphelpers.dev/icons/ for icon ref
 ...
 */
function colWidthToClassName(width) {
  let className;
  switch (width) {
    case "66.66%":
      className = " md-8";
...
/* harmony import */ var _column__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../column */ "./src/column/index.js");
...
const Save = props => {
  ...
  blockProps.className += " " + (0,_column__WEBPACK_IMPORTED_MODULE_2__.colWidthToClassName)(columnWidth);
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...blockProps
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"ezpz/column","version":"0.1.0","title":"Column","category":"layout","description":"A single column containing content.","parent":["ezpz/columns"],"supports":{"html":false,"customClassName":false,"anchor":false,"color":{"background":false,"text":false}},"attributes":{"width":{"type":"string","default":"50%"}},"textdomain":"ezpz-column","editorScript":"file:./index.js"}');
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/column/index.js");
/******/ 	
/******/ })()
;
