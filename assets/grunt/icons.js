...
module.exports = function (grunt) {
  ...
  grunt.config("svgstore", {
    options: {
      ...
      svg: {
        // will add and override the the default xmlns="http://www.w3.org/2000/svg" attribute to the resulting SVG
        viewBox: "0 0 100 100",
    ...
    default: {
      files: {
        "<%= opts.dist_dir %>/icons/icons.svg": [
          "<%= opts.dist_dir %>/icons/*.svg",
        ],
      },
    },
  });
