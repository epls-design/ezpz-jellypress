    ...
    <div id="primary" class="content-area col">
      <main id="main" class="site-main">
        ...
        <?php while ( have_posts() ) :
          the_post();
          get_template_part( 'template-parts/layout/hero/hero', get_post_type() ); // TODO: This doesn't work so well within this layout, but single-sidebar is rarely used anyway.
