...
if ( ! function_exists( 'jellypress_change_post_object_labels' ) ) :
  function jellypress_change_post_object_labels() {
      ...
      $labels->add_new_item = __( 'Add New News', 'jellypress' );
      $labels->add_new = __( 'Add New', 'jellypress' );
      $labels->new_item = __( 'New News', 'jellypress' );
      $labels->edit_item = __( 'Edit News', 'jellypress' );
      $labels->update_item = __( 'Update News', 'jellypress' );
      $labels->view_item = __( 'View News', 'jellypress' );
      $labels->view_items = __( 'View News', 'jellypress' );
      ...
      $labels->insert_into_item = __( 'Insert into News', 'jellypress' );
      $labels->uploaded_to_this_item = __( 'Uploaded to this News', 'jellypress' );
